...
impl From<FTFL_A> for bool {
    #[inline(always)]
    fn from(variant: FTFL_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Reader of field `FTFL`"]
pub type FTFL_R = crate::R<bool, FTFL_A>;
impl FTFL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> FTFL_A {
        match self.bits {
            false => FTFL_A::_0,
            true => FTFL_A::_1,
        }
...
#[doc = "Write proxy for field `FTFL`"]
pub struct FTFL_W<'a> {
    w: &'a mut W,
}
impl<'a> FTFL_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: FTFL_A) -> &'a mut W {
        {
    ...
    pub fn _0(self) -> &'a mut W {
        self.variant(FTFL_A::_0)
    }
    #[doc = "Clock enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(FTFL_A::_1)
    }
...
impl R {
    ...
    #[inline(always)]
    pub fn ftfl(&self) -> FTFL_R {
        FTFL_R::new((self.bits & 0x01) != 0)
    }
